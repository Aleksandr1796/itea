...
*/
  ...
  var prevButton = document.getElementById('PrevSilde');
  var nextButton = document.getElementById('NextSilde');

  var image = document.createElement('img');

  window.addEventListener('load', function(){
    image.src = OurSliderImages[0];
  ...
  nextButton.onclick = function nextSlide(){
    ...
    currentPosition++;
    if (currentPosition==7) currentPosition = -1;
  };
